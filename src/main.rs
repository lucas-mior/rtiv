...
// fn usage() {
    // println!("usage: stiv IMAGE W H [X Y]\n");
    // println!("       stiv -h | --help\n");
    // println!("       stiv -c | --clear 0 | 1\n");
    // println!("Be sure to have ueberzug running in the terminal and UZUG env variable set\n");
    // exit(1);
// }
